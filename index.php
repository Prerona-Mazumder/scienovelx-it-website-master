...
<section class="services-area-two pt-100 pb-70">
    <div class="container">
        ...
        <div class="text-center">
            <a href="services.php" class="default-btn btn-bg-two border-radius-50">Explore More<i class='bx bx-chevron-right'></i></a>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <div class="award-area ptb-100">
                    <div class="container">
                        <div class="row">
                            <div class="award-item col-sm">
                                <a target="blank" href="assets/certificates/SCIENOVELX EDUCATION & TECHNOLOGY SOLUTIONS PRIVATE LIMITED_ISO.pdf">
                                    <img class="award-img" src="assets/images/brand-logo/brand-logo3.png" alt="Images">
                                </a>
                            </div>
                            <div class="award-item col-sm">
                                <a target="blank" href="assets/certificates/SUBHAJIT GHOSH_CER.pdf">
                                    <img class="award-img" src="assets/images/brand-logo/brand-logo2.png" alt="Images">
                                </a>
                            </div>
                        </div>
                        <div class="row">
...
<section class="clients-area pt-100 pb-70">
    <div class="container">
        <div class="section-title text-center">
            ...
            <h2>OUR (CEO)FOUNDER'S MESSAGE</h2>
        </div>
