            ...
            <div class="col-lg-12">
                ...
                <div class="single-content">
                    <p>
                        ...
                        <strong> READ THIS TERMS OF SERVICE AGREEMENT CAREFULLY, AS IT CONTAINS IMPORTANT INFORMATION REGARDING YOUR LEGAL RIGHTS AND REMEDIES.</strong>
                        <br /><br />
                        Last Revised: 2021-09-30 15:30:54
                    </p>
                    <h3>01. Overview</h3>
                    <p>
                        This Terms of Service Agreement ("Agreement") is entered into by and between Scienovelx, registered address Plot No.E-1, Block K, SP Shukhobrishti Action Area III, Newtown, E-2, Rajarhat, Kolkata, West Bengal 700135, India ("Company") and you, and is made effective as of the date of your use of this website http://scienovelx.com ("Site") or the date of electronic acceptance.
                        <br /><br />
                        This Agreement sets forth the general terms and conditions of your use of the http://scienovelx.com as well as the products and/or services purchased or accessed through this Site (the "Services").Whether you are simply browsing or using this Site or purchase Services, your use of this Site and your electronic acceptance of this Agreement signifies that you have read, understand, acknowledge and agree to be bound by this Agreement our Privacy policy. The terms "we", "us" or "our" shall refer to Company. The terms "you", "your", "User" or "customer" shall refer to any individual or entity who accepts this Agreement, uses our Site, has access or uses the Services. Nothing in this Agreement shall be deemed to confer any third-party rights or benefits.
                        <br /><br />
                        ...
                        <br /><br />
                        <strong>IF YOU DO NOT AGREE TO BE BOUND BY THIS AGREEMENT AS LAST REVISED, DO NOT USE (OR CONTINUE TO USE) THIS SITE OR THE SERVICES.</strong>

                    </p>
                </div>
                <div class="single-content">
                    <h3>02. ELIGIBILITY</h3>
                    <p>
                ...
                <div class="single-content">
                    <h3>03. RULES OF USER CONDUCT</h3>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>copy or duplicate this Terms of Services agreement, which was created with the help of the <a style="text-decoration:none;color: inherit;" href="https://termshub.io?utm_source=referral&amp;utm_medium=generated_documents&amp;utm_campaign=referral_documents&amp;utm_content=tos_th_text" target="_blank">TermsHub.io</a> and the <a style="text-decoration:none;color: inherit;" href="https://termshub.io/terms-of-service?utm_source=referral&amp;utm_medium=generated_documents&amp;utm_campaign=referral_documents&amp;utm_content=tos_th_text" target="_blank">T&amp;C Generator</a> ,</li>
                ...
                <div class="single-content">
                    ...
                    <p>
                        In addition to the general rules above, the provisions in this Section apply specifically to your use of Companies Content posted to Site. Companies Content on this Site, including without limitation the text, software, scripts, source code, API, graphics, photos, sounds, music, videos and interactive features and the trademarks, service marks and logos contained therein ("Companies Content"), are owned by or licensed to Scienovelx in perpetuity, and are subject to copyright, trademark, and/or patent protection.
                        <br /><br />
                ...
                <div class="single-content">
                    <h3>05. YOUR USE OF USER CONTENT</h3>
                    <p>
                ...
                <div class="single-content">
                    <h3>06. COMPANIES USE OF USER CONTENT</h3>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Your User Submissions do not establish a confidential relationship or obligate Company to treat your User Submissions as confidential or secret.</li>
                        <li>Company has no obligation, either express or implied, to develop or use your User Submissions, and no compensation is due to you or to anyone else for any intentional or unintentional use of your User Submissions.</li>
                    </ul>
                ...
                <div style="margin-bottom: 1rem">
                    ...
                    <div style="margin: .5rem 0">IN NO EVENT SHALL COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AND ALL THIRD PARTY SERVICE PROVIDERS, BE LIABLE TO YOU OR ANY OTHER PERSON OR ENTITY FOR ANY DIRECT, INDIRECT, INCIDENTAL, SPECIAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES WHATSOEVER, INCLUDING ANY DAMAGES THAT MAY RESULT FROM
                        ...
                        (IX) ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF YOUR USE OF THIS SITE OR THE SERVICES FOUND AT THIS SITE, WHETHER BASED ON WARRANTY, CONTRACT, TORT, OR ANY OTHER LEGAL OR EQUITABLE THEORY, AND WHETHER OR NOT COMPANY IS ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.</div>
                    ...
                    <div style="margin: .5rem 0">THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW, AND shall survive any termination or expiration of this Agreement or your use of this Site or the Services found at this Site.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">9. INDEMNITY</h3>
                    <div style="margin: .5rem 0">You agree to protect, defend, indemnify and hold harmless Company and its officers, directors, employees, agents from and against any and all claims, demands, costs, expenses, losses, liabilities and damages of every kind and nature (including, without limitation, reasonable attorneys’ fees) imposed upon or incurred by Company directly or indirectly arising from (i) your use of and access to this Site; (ii) your violation of any provision of this Agreement or the policies or agreements which are incorporated herein; and/or (iii) your violation of any third-party right, including without limitation any intellectual property or other proprietary right. The indemnification obligations under this section shall survive any termination or expiration of this Agreement or your use of this Site or the Services found at this Site.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">10. DATA TRANSFER</h3>
                    <div style="margin: .5rem 0">If you are visiting this Site from a country other than the country in which our servers are located, your communications with us may result in the transfer of information across international boundaries. By visiting this Site and communicating electronically with us, you consent to such transfers.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">11. AVAILABILITY OF WEBSITE</h3>
                    <div style="margin: .5rem 0">Subject to the terms and conditions of this Agreement and our policies, we shall use commercially reasonable efforts to attempt to provide this Site on 24/7 basis. You acknowledge and agree that from time to time this Site may be inaccessible for any reason including, but not limited to, periodic maintenance, repairs or replacements that we undertake from time to time, or other causes beyond our control including, but not limited to, interruption or failure of telecommunication or digital transmission links or other failures.</div>
                    <div style="margin: .5rem 0">You acknowledge and agree that we have no control over the availability of this Site on a continuous or uninterrupted basis, and that we assume no liability to you or any other party with regard thereto.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">12. DISCONTINUED SERVICES</h3>
                    <div style="margin: .5rem 0">Company reserves the right to cease offering or providing any of the Services at any time, for any or no reason, and without prior notice. Although Company makes great effort to maximize the lifespan of all its Services, there are times when a Service we offer will be discontinued. If that is the case, that product or service will no longer be supported by Company. In such case, Company will either offer a comparable Service for you to migrate to or a refund. Company will not be liable to you or any third party for any modification, suspension, or discontinuance of any of the Services we may offer or facilitate access to.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">13. FEES AND PAYMENTS</h3>
                    <div style="margin: .5rem 0">You acknowledge and agree that your payment will be charged and processed by Scienovelx.</div>
                    <div style="margin: .5rem 0">You agree to pay any and all prices and fees due for Services purchased or obtained at this Site at the time you order the Services.</div>
                    <div style="margin: .5rem 0">Company expressly reserves the right to change or modify its prices and fees at any time, and such changes or modifications shall be posted online at this Site and effective immediately without need for further notice to you.</div>
                    <div style="margin: .5rem 0">Refund Policy: for products and services eligible for a refund, you may request a refund under the terms and conditions of our Refund Policy which can be accessed <a href="https://portal.termshub.com/ankangh.com#refund_policy" target="_blank">here.</a></div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">14. NO THIRD-PARTY BENEFICIARIES</h3>
                    <div style="margin: .5rem 0">Nothing in this Agreement shall be deemed to confer any third-party rights or benefits.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">17. DISPUTE RESOLUTION</h3>
                    <div style="margin: .5rem 0">Any controversy or claim arising out of or relating to these Terms of Services will be settled by binding arbitration. Any such controversy or claim must be arbitrated on an individual basis, and must not be consolidated in any arbitration with any claim or controversy of any other party. The arbitration must be conducted in India, West Bengal, and judgment on the arbitration award may be entered into any court having jurisdiction thereof.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">18. TITLES AND HEADINGS</h3>
                    <div style="margin: .5rem 0">The titles and headings of this Agreement are for convenience and ease of reference only and shall not be utilized in any way to construe or interpret the agreement of the parties as otherwise set forth herein.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">19. SEVERABILITY</h3>
                    <div style="margin: .5rem 0">Each covenant and agreement in this Agreement shall be construed for all purposes to be a separate and independent covenant or agreement. If a court of competent jurisdiction holds any provision (or portion of a provision) of this Agreement to be illegal, invalid, or otherwise unenforceable, the remaining provisions (or portions of provisions) of this Agreement shall not be affected thereby and shall be found to be valid and enforceable to the fullest extent permitted by law.</div>
                </div>
                <div style="margin-bottom: 1rem">
                    <h3 style="font-weight: 600; margin: 0; text-transform: uppercase">20. CONTACT INFORMATION</h3>
                    <div style="margin: .5rem 0">If you have any questions about this Agreement, please contact us by email or regular mail at the following address:</div>
                    <div style="margin: .5rem 0">Scienovelx</div>
                    <div style="margin: .5rem 0">Plot No.E-1, Block K, SP Shukhobrishti Action Area III, Newtown, E-2, Rajarhat, Kolkata, West Bengal 700135</div>
                    <div style="margin: .5rem 0">India</div>
                    <div style="margin: .5rem 0">Email: info@scienovelx.com</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from templates.hibootstrap.com/techex/default/terms-condition.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 11 Jul 2021 11:55:57 GMT -->
